This project works with the King County House Sales dataset. The dataset has been modified to make it a bit more fun and challenging.  The dataset can be found in the file `"kc_house_data.csv"`, in this repo. 
